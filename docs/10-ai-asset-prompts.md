...
## Consistency Prompt Header

Prepend this block to **every** image prompt to maintain visual consistency across all assets:

```
CONSISTENCY HEADER (paste at the start of every image prompt):

Style: editorial lifestyle photography, soft diffused natural light from the left,
warm color grade (+10 temperature, slightly matte/film-look, desaturated highlights),
clean white (#FFFFFF) or warm off-white (#F7F5F2) background,
minimal props (max 3: ceramic tray, small potted plant, folded linen towel),
no people's faces visible OR diverse skin tones only (no specific celebrity or recognizable person),
aspect ratio as specified per prompt,
do NOT reference any trademarked brand, logo, or copyrighted character.
```
...
Color: deep forest green (#1E3A2F) on a clean white (#F7F5F2) background.
No gradients, no drop shadows, no 3D effects, no outlines.
Clean, modern, suitable for a premium eco-conscious skincare brand.
Deliverable: flat vector-friendly style, white background, square crop 1:1.
Do NOT include any trademarked logos, brand elements, or celebrity likeness.
```
...
Use the Consistency Header for all of these. Specify 4:5 aspect ratio for social, 16:9 for hero.
...
### Image 3 — Pod Dissolving into Foam

```
[CONSISTENCY HEADER]
Aspect ratio: 1:1.
Macro close-up: a single pod mid-dissolve in wet palms (light-brown skin),
creating a cloud of white foam. Water droplets visible.
Satisfying texture, sharp focus on the foam. Clean white background.
```

### Image 4 — Morning Bathroom Shelf
...
### Image 5 — Flat Lay Product Spread
...
Overhead shot, perfectly centered, natural shadows.
```

### Image 6 — Travel / On-the-Go
...
### Image 8 — Diverse Skin Tone Hands
...
### Image 9 — Before/After Routine Table (SAFE version — no skin comparison)
...
## 10 Product Mockups (White Background + Soft Shadow)

Use with **Canva's Smart Mockup**, **Placeit**, Midjourney, or Photoshop.

### Mockup 1 — Single Pod, Front-Facing
...
### Mockup 2 — 6-Pod Starter Pack Box
...
### Mockup 3 — 18-Pod 3-Month Supply Box

```
Product mockup: larger rectangular box (approx 5"×3"×2"),
same forest green and white branding as above,
"3-Month Supply — 18 Pods" on front panel.
Pure white background, soft drop shadow. 3/4 angle view.
```

### Mockup 4 — Travel Pod Case (Silicone Pouch)

```
Product mockup: small silicone zip pouch (4"×3"),
sage green color, minimal "LL" monogram embossed on front.
Pure white background, soft drop shadow. Front-facing 1:1.
```
...
### Mockups 6–10 — Lifestyle Mockups on Surface
...
Surfaces to use: marble counter, light wood shelf, white linen cloth, pale concrete, frosted glass shelf.

---

## 5 Short Video Storyboard Prompts (15–25 seconds)

Use with **Runway Gen-3**, **Pika Labs**, **Kling AI**, or **Sora** when available.  
Each prompt includes scene description, camera movement, and audio cue.

---

### Video 1 — "The Pod Dissolves" (Satisfying Hook)

```
AI VIDEO PROMPT:
Scene: Extreme close-up of a small oval pod resting in a wet palm (medium-brown skin, no face visible).
The pod begins to dissolve as water contacts it, creating expanding white foam bubbles.
Camera: slow push-in macro, very slight pull-back as foam grows.
Duration: 15 seconds.
Color: warm, soft diffused natural light, high contrast on the foam texture.
Audio cue: gentle water drip sound, then soft ambient piano note (no narration needed).
End frame: foam filling the palm, pod fully dissolved.
Style: satisfying, ASMR-adjacent, clean beauty aesthetic.
Do NOT include any copyrighted music, brand references, or celebrity likeness.
```

---

### Video 2 — "Morning Routine In 8 Seconds" (Speed-Run Reel)
...
Camera: handheld, slightly shaky "real morning" feel. No tripod.
Audio: upbeat lo-fi rhythm, no lyrics.
Text overlay (bottom third): "Your whole morning wash. One pod. 8 seconds."
Do NOT include any copyrighted music or celebrity likeness.
```

---

### Video 3 — "Plastic Bottle vs. Pod" (Comparison Hook)
...
Audio: faint "cluttered" ambient sound LEFT → clean chime / silence RIGHT.
Text overlay at end: "Less baggage. More ritual."
Do NOT reference or show any real brand's bottles.
```

---

### Video 4 — "Unboxing & First Use" (Trust Builder)
...
(0:22–0:25): Pod wrapper placed in small recycle bin. Hands clean and dry.
Camera: overhead for unboxing → eye-level for use sequence.
Audio: soft ambient nature sounds + a single musical note at end.
Style: deliberate, calm, premium skincare brand feel.
```

---

### Video 5 — "The 30-Day Challenge" (Story Arc Hook)

```
AI VIDEO PROMPT:
Scene: Day-counter montage — feel of a "7-day / 30-day challenge" video.
(0:00–0:05): Text: "I replaced my entire cleanser collection with 6 pods."
           Cut to: a cluttered bathroom shelf with multiple bottles.
...
Audio: building ambient background, resolves to calm note at end.
Text: DM Sans Bold, forest green (#1E3A2F), lower-third placement.
```
